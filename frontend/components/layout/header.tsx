  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-[#7B3306] backdrop-blur-md shadow-lg"
          : "md:bg-[#7B3306] bg-white/95 ",
      )}
    >
      ...
      <nav className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-[8rem] h-12 rounded-full flex items-center justify-center text-white font-bold text-lg  group-hover:scale-105 transition-transform">
